...
const About = () => {
    ...
    return (
        <>
            ...
            <MainLayout>
                <div className="h-full w-full flex flex-col p-4 border-2 border-primary-dark">
                    <NavBar />
                    <div className="flex flex-col overflow-y-auto overflow-x-hidden scrollbar-hide">
                        ...
                        <div className="flex flex-col w-full space-y-2 text-lg text-primary-dark">
                            ...
                            <AboutSection
                                ...
                                content={
                                    <>It's top secret... just kidding geoChat is completely <a href="https://github.com/ShaneBerhoff/geoChat" className="text-primary hover:text-primary-darker underline">open source</a>, so if you are curious about how anything works you can see every line of code.</>}
                                className=""
                            />
                            <AboutSection
                                title="Data Privacy"
                            ...
                            <AboutSection
                                ...
                                content={<>Emory University, Lullwater Preserve, Clairmont Campus: <a href="https://github.com/ShaneBerhoff/geoChat" className="text-primary hover:text-primary-darker underline">Want to add your own locations?</a></>}
                                className=""
                            />
                            <AboutSection
